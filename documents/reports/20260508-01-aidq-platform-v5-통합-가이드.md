...
| 수신 | 웹 백엔드 측 |
| 작성일 | 2026-05-08 |
| 대상 repo | github.com/jnujh/aidq-platform |
...
- 코드 관련 → capstone-dsc repo issue 또는 메신저
- 통합 막힘 → 메신저 (DSC 측)
- 가중치/정의식 변경 요청 → 협의 필요 (사전등록 원칙으로 임의 변경 불가, 부록 C 참조)
...
| 이슈 발생 시 | 7절 자주 발생하는 이슈 → 미해결 시 메신저 |
