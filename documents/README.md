...
└── reports/           # 제출용 보고서 — 주차별 활동 요약 및 차기 계획
```
...
### reports/
교수님/외부 제출용 주차별 보고서. progress/의 세부 기록을 요약해 활동 내용과 차기 계획 중심으로 작성한다.
- 네이밍: `YYYYMMDD-순번-week{N}.md` (작성일 기준, 주차는 N으로 표기)
- 포함할 것: 활동 내용, 현재 문제점, 차기 계획, 일정
